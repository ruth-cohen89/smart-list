...
const BaselineItemSchema = new Schema<IBaselineItemDocument>(
    {
        ...
        normalizedName: { type: String, required: true, trim: true, lowercase: true, minlength: 1, maxlength: 120 },
...
export default mongoose.model<IConsumptionProfileDocument>('ConsumptionProfile', ConsumptionProfileSchema);
