...
export class CatalogImportController {
  ...
  /**
   * POST /api/v1/catalog-import/:chainId
   * Trigger an import for a single chain.
   */
  ...
  /**
   * POST /api/v1/catalog-import/run-all
   * Trigger an import for all supported chains sequentially.
   */
