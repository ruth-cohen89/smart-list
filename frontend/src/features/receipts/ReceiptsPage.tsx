      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Upload a photo or PDF of your receipt. SmartList will scan it and match items automatically.
          </p>
        </div>
          ...
          {uploading ? (
            ...
            <>
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7l3 3 3-3m0 0V9" />
              </svg>
